...
<div>
    <div class="row margin-top-15px"> // show in genetic
        <div class="col l3 white z-depth-2">
            <div class="col l12">
        ...
        <div class="col l9 white z-depth-2">
            <div class="row">
                <div class="col s12">
                    <p class="center-align col s12">Вопрос:  ${currentQuestion.getQuestion().getQuestion()}</p>
